...
<div class="faq-item">
    ...
    <div>
        <p>No. PrimerWeaver is <strong>free for academic and non-commercial use</strong>. Source code is released under the MIT License. No login or cookies are required, respecting the NAR Web Server guidelines.</p>
    </div>
    </details>
</div>
...
<div class="faq-item">
    ...
    <div>
        ...
        <li>Specify the overlap length (typically 8–20 bp).</li>
...
<div class="faq-item">
    <svg class="faq-icon" aria-hidden="true"><use xlink:href="#icon-download"></use></svg>
    <details class="faq-content">
...
<div class="faq-item">
    ...
    <div>
        ...
        <li><strong>GitHub Issues:</strong> Visit the <a href="https://github.com/katewillisu/primerweaver" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: underline;">PrimerWeaver GitHub repository</a> and open an issue (requires a free GitHub account).</li>
...
<div class="card" style="padding:22px 28px">
    ...
    <div class="about-content">
        ...
        <li><strong>Version:</strong> v1.1.12</li>
        </ul>
    </div>
    </div>
