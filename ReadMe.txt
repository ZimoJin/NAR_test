...
Performance notes (online)
- The app renders module HTML first, then initializes module JS after the first paint to keep the UI responsive.
- `app/app-index.html` includes `modulepreload` hints for the loader, CORE/VIZ, and the default Golden Gate module to reduce time-to-interactive on slow networks.
